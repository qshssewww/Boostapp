...
class Query {
	...
	public function insert(array $values)
	{
		...
		global $debugInsertSql;
		if(isset($debugInsertSql) && $debugInsertSql === true) return $this->toString($sql, $bindings);
	...
	public function getBindings(){
		 ...
		 */
		public function toString($query = null, $params = null) {
			$query = ($query == null) ? $this->toSql() : $query;
			$params = ($params == null) ? $this->bindings : $params;
