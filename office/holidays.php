...
function sorted_holidays() {
  ...
  $holidays = array(
    array('name' => 'ראש השנה', 'month' => 1, 'day' => 1, 'duration' => 2),  // Begins 1 Tishrei
    array('name' => 'יום כיפור', 'month' => 1, 'day' => 10, 'duration' => 1),  // 10 Tishrei
    array('name' => 'סוכות', 'month' => 1, 'day' => 15, 'duration' => 7),  // Begins 15 Tishrei
    array('name' => 'שמיני עצרת', 'month' => 1, 'day' => 22, 'duration' => 1),  // 22 Tishrei (follows Sukkot)
    array('name' => 'שמחת תורה', 'month' => 1, 'day' => 23, 'duration' => 1),  // 23 Tishrei (in Israel, same day as Shemini Atzeret; diaspora rules used here)
    array('name' => 'חנוכה', 'month' => 3, 'day' => 25, 'duration' => 8),  // Begins 25 Kislev
    array('name' => 'טו בשבט', 'month' => 5, 'day' => 15, 'duration' => 1), // 15 Shevat
    array('name' => 'פורים', 'month' => is_heb_leap_year($jyear) ? 7 : 6, 'day' => 14, 'duration' => 1), // 14 Adar II in leap years, 14 Adar in non-leap years
    array('name' => 'פסח', 'month' => 8, 'day' => 15, 'duration' => 8), // Begins 15 Nisan
    array('name' => 'שבועות', 'month' => 10, 'day' => 6, 'duration' => 2), // 6 Sivan
    array('name' => 'תשעה באב', 'month' => 12, 'day' => 9, 'duration' => 1), // 9 Av
  );
