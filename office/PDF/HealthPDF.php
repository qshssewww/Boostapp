...
defined('TBL_DYNAMICFORMANSWERS') or define('TBL_DYNAMICFORMANSWERS', 'healthforms_answers');
defined('TBL_DYNAMICFORM') or define('TBL_DYNAMICFORM', 'healthforms');
...
$BusinessGoogleAddress = ClientGoogleAddress::getBusinessAddress($CompanyNum);
...
//פרטי עסק
$CompanyFullAddress = $BusinessGoogleAddress->address ?? $CompanyFullAddress;
...
$DocHtml .= sprintf('<h3>חתימת לקוח</h3>');
    ...
    try {
        if (str_contains($data->data->signuture, 'data:image/svg+xml;base64,')) {
