...
$Items = DB::table('log')->where('CompanyNum','=',$CompanyNum)->whereBetween('Dates', array($StartDate, $EndDate))->orderBy('id', 'DESC')->get();
...
$LogContent = "<i class='fa fa-filter' aria-hidden='true'></i> ".$LogUserName." נכנס ל<a href='LogList.php' target='_blank'>לוג מערכת</a>";
...
$(document).ready(function(){
   ...
   var categoriesDataTable =   $('#categories').dataTable( {
		...
		//{extend: 'copy', text: 'העתק <i class="fa fa-clipboard" aria-hidden="true"></i>', className: 'btn btn-info'},
			{extend: 'excelHtml5',  text: 'Excel <i class="fas fa-file-excel" aria-hidden="true"></i>', filename: '<?php echo lang('system_log') ?>', className: 'btn btn-dark'},
			{extend: 'csvHtml5', text: 'CSV <i class="fas fa-file-code" aria-hidden="true"></i>', filename: '<?php echo lang('system_log') ?>', className: 'btn btn-dark'},
           // 'pdfHtml5'
		<?php endif ?>
			
        ],
	   
	   		ajax: { url: 'LogPost.php?<?php echo @$_SERVER['QUERY_STRING']; ?>', },
...
<i class="fas fa-filter"></i> לוג מערכת <span style="color:#48AD42;"><?php //echo $resultcount; ?> </span>
</div>
</h3>
</div>
...
<nav aria-label="breadcrumb" >
  ...
  <li class="breadcrumb-item active">לוג מערכת</li>
  </ol>  
</nav>     -->
...
<div class="col-md-10 col-sm-12">	
    ...
    <i class="fas fa-filter"></i> <b><?php echo lang('system_log') ?> <span class="text-primary"><?php echo $resultcount; ?> </span></b> 
 	</div>    
  	<div class="card-body">       
...
<table class="table table-bordered table-hover dt-responsive text-start display wrap" id="categories"  cellspacing="0" width="100%">
		<thead class="thead-dark">
			<tr>
                ...
                <th class="text-start lastborder"><?php echo lang('representative') ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<tfoot>
            <tr>
                ...
                <th class="lastborder"><span><?php echo lang('representative') ?></span></th>
            </tr>
        </tfoot>
