...
<?php if ($ClassInfo->Status=='1' || $ClassInfo->Status=='2'){ ?>
            ...
            <?php echo lang('cant_complete_class') ?><br>
...
<?php
 ...
 <form action="CancelEventPopUp"  class="ajax-form clearfix">
<input type="hidden" name="ClassIdCloseEvent" id="ClassIdCloseEvent" value="<?php echo $Id; ?>">
     
	        
		        <div class="form-group" >
                <label style="font-size: 30px;"><?php echo lang('class_cancel_notice') ?></label>
                </div>  
                
                <div class="alertb alert-danger" >
                <?php echo lang('class_cancel_attention') ?><br>
                </div>	
