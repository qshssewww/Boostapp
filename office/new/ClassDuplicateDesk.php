...
<input type="hidden" name="CalendarId" value="">
 ...
 <div class="col-md-4">	 
  ...
  <label>מיקום שיעור</label>
    <select class="form-control js-example-basic-single text-right" name="FloorId" id="ChooseAgentForTaskA" dir="rtl" data-placeholder="בחר מיקום לשיעור" style="width: 100%" >
  <?php 
...
?>  
 ...
 <div class="col-md-3">	     
  ...
  <input name="SetDate" id="SetDateA" type="date"  value="" class="form-control">
	</div>  
  </div>
 ...
 <select name="Day" id="DayA" data-placeholder="בחר יום" class="form-control" style="width:100%;">
 ...
 <div class="col-md-3">	     
  ...
  <label>שעת סיום</label>
	 <input name="SetToTime" id="SetToTimeA" type="time" step="300" min="" value="<?php echo $ClassInfo->EndTime; ?>" class="form-control">  
	</div> 
  </div>      
 ...
 <div class="col-md-4">	        
  ...
  <label>אופי השיעור</label>
    <select class="form-control text-right" name="ClassType" id="ClassTypeA" dir="rtl" >
