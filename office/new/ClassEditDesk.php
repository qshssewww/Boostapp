...
<?php if ($ClassInfo->Status=='55' || $ClassInfo->Status=='55'){ ?>
 
		        <div class="alertb alert-warning" dir="rtl">
                לא ניתן לערוך/לבטל שיעור שכבר הושלם.<br>
                </div>  
...
<form action="AddClassDesk" id="FormAddClassDesks"  class="ajax-form clearfix text-right" autocomplete="off" novalidate>
...
<input type="hidden" name="FloorId" value="<?php echo $ClassInfo->Floor; ?>">      
  <label>מיקום שיעור</label>
    <select class="form-control js-example-basic-single text-right" name="FloorIdOld" id="ChooseAgentForTaskA" dir="rtl" data-placeholder="בחר מיקום לשיעור" style="width: 100%"  disabled >
  <?php 
 ...
 <div class="col-md-4">	 
  ...
  <label>סוג שיעור</label>
    <select class="form-control js-example-basic-single select2Desk text-right" name="ClassNameType" id="ClassNameTypeA" dir="rtl" data-placeholder="בחר סוג שיעור" >
    <option value=""></option>    
  <?php 
 ...
 <div class="col-md-4">	 
  ...
  <label>מוצג באפליקציה?</label>
    <select class="form-control js-example-basic-single text-right" name="ShowApp" id="ShowAppA" dir="rtl" >
 ...
 <div class="col-md-4">	     
  ...
  <label>כותרת השיעור</label>
	<input type="text" class="form-control" name="ClassName" id="ClassNameA" value="<?php echo $ClassInfo->ClassName; ?>" >  
	</div>  
  </div>
 ...
 <div class="col-md-4">	     
  <div class="form-group">
  <label>מדריך</label>
    <select class="form-control js-example-basic-single select2Desk text-right" name="GuideId" id="GuideIdA" dir="rtl" data-placeholder="בחר מדריך לשיעור" >
    <option value=""></option>    
  <?php 
  if ($BrandsMain=='0'){       
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-right" name="ClassLevel" id="ClassLevelA" dir="rtl" >
 ...
 <div class="col-md-4">	     
  ...
  <label>מקסימום משתתפים</label>
	<input type="text" class="form-control" name="MaxClient" id="MaxClientA" value="<?php echo $ClassInfo->MaxClient; ?>" >  
	</div> 
  </div>     
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-right" name="MinClass" id="MinClassA" dir="rtl" >
  ...
  <label>מינימום משתתפים</label>
	<input type="number" class="form-control" name="MinClassNum" id="MinClassNum" value="<?php echo $ClassInfo->MinClassNum; ?>" >  
	</div>  
  </div>
  ...
  <label>זמן בדיקת מינימום משתתפים לפני השיעור</label>
	<input type="text" class="form-control" name="ClassTimeCheck" id="ClassTimeCheckA" value="<?php echo @$ClassInfo->ClassTimeCheck; ?>">  
	</div>
    </div>   
     <div class="col-md-6">	   
    <div class="form-group">
    <label>אפשרות</label>
    <select class="form-control text-right" name="ClassTimeTypeCheck" id="ClassTimeTypeCheckA" dir="rtl">
...
?>  
 ...
 <div class="col-md-3">	     
  ...
  <label>שעת התחלה</label>
	  <input name="SetTime" id="SetTimeA" type="time" step="300" value="<?php echo $ClassInfo->StartTime; ?>" class="form-control">  
	</div> 
  </div>
 ...
 <div class="col-md-3">	     
  ...
  <label>שעת סיום</label>
	 <input name="SetToTime" id="SetToTimeA" type="time" step="300" min="<?php echo blockMinutesRound(date(('H:i'), strtotime("+5 minutes", strtotime($ClassInfo->StartTime)))); ?>" value="<?php echo $ClassInfo->EndTime; ?>" class="form-control">  
	</div> 
  </div>      
 ...
 <div id="DivClassTypeA" class="col-md-3" style="display: <?php if ($ClassInfo->ClassType=='2') { echo 'selected'; } else { echo 'none'; } ?>;">	        
  ...
  <input type="text" class="form-control" name="ClassCount" id="ClassCountA" value="<?php echo $ClassInfo->ClassCount; ?>" min="1" > 
  </div>
 </div>       
 ...
 <div class="col-md-5">	        
  ...
  <label>הצג בחירת מכשירים</label>
    <select class="form-control js-example-basic-single select2Desk text-right" name="ClassDevice" id="ClassDeviceA" dir="rtl" data-placeholder="בחר טבלת מכשירים"  >
    <option value=""></option>    
  <?php 
...
<hr>
  ...
  <label>בחר סוג מנוי להזמנת שיעור זה</label>
    <select class="form-control js-example-basic-single select2multipleDesk text-right" name="ClassMemberType[]" id="ClassMemberTypeA" dir="rtl"  multiple="multiple" >
    <option value=""></option>
...
<hr>
  ...
  <select class="form-control text-right" name="ShowClientNum" id="ShowClientNumA" dir="rtl" >
 ...
 <div class="col-md-6">	     
  ...
  <select class="form-control text-right" name="ShowClientName" id="ShowClientNameA" dir="rtl" >
 ...
 <div class="row">
  ...
  <select class="form-control text-right" name="ClassWating" id="ClassWatingA" dir="rtl" >
  ...
  <select class="form-control text-right" name="MaxWatingList" id="WatingListActA" dir="rtl">
  ...
  <input type="number" class="form-control" name="NumMaxWatingList" id="WatingListNumA" value="<?php echo $ClassInfo->NumMaxWatingList ?>" onkeypress='validate(event)'> 
  </div> 
  </div>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-right" name="SendReminder" id="SendReminderA" dir="rtl" >
  ...
  <select class="form-control text-right" name="TypeReminder" id="TypeReminderA" dir="rtl" >
  ...
  <input type="time" class="form-control" name="TimeReminder" id="TimeReminderA" step="300" value="<?php echo $ClassInfo->TimeReminder; ?>" max="" min="" >     
  </div> 
  </div>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-right" name="CancelLaw" id="CancelLawA" dir="rtl" >
  ...
  <select name="CancelDay" id="CancelDayA" data-placeholder="בחר יום" class="form-control" style="width:100%;" >
  ...
  <input name="CancelTillTime" id="CancelTillTimeA" type="time" step="300" min="" value="<?php echo $ClassInfo->CancelTillTime; ?>" class="form-control" >           
  </div> 
  </div>
...
<div id="DivCancelLaw4A" class="alertb alert-warning" style="display: <?php if ($ClassInfo->CancelLaw=='4') { echo 'selected'; } else { echo 'none'; } ?>;">שים לב! באפשרות זו, ללקוח לא יופיע כפתור ביטול באפליקציה לאחר הזמנת שיעור זה.</div>   
  ...
  <div class="form-group">
  <label>ערוך כקבוצה?</label>
    <select class="form-control js-example-basic-single text-right" name="GroupEdit" id="GroupEdit" dir="rtl" >
    <option value="0">לא (ערוך שיעור זה בלבד)</option>
<!--     --><?php //if (Auth::userCan('90')): ?><!--   -->
    <option value="1">כן (ערוך את כל הקבוצה החל מתאריך שיעור זה והלאה)</option> 
<!--     --><?php //endif ?><!--     -->
  </select> 
  </div>      
...
if (Id=='0') {    
/// ראשון    
$('#CancelDayA').find('option').remove().end().append('<option value="">בחר יום</option><option value="6">שבת</option><option value="5">שישי</option><option value="4">חמישי</option><option value="3">רביעי</option><option value="2">שלישי</option><option value="1">שני</option><option value="0" >ראשון</option>'); 
}
else if (Id=='1') {     
/// שני    
$('#CancelDayA').find('option').remove().end().append('<option value="">בחר יום</option><option value="0">ראשון</option><option value="6">שבת</option><option value="5">שישי</option><option value="4">חמישי</option><option value="3">רביעי</option><option value="2">שלישי</option><option value="1" >שני</option>');
}
else if (Id=='2') {      
/// שלישי    
$('#CancelDayA').find('option').remove().end().append('<option value="">בחר יום</option><option value="1">שני</option><option value="0">ראשון</option><option value="6">שבת</option><option value="5">שישי</option><option value="4">חמישי</option><option value="3">רביעי</option><option value="2" >שלישי</option>'); 
}
else if (Id=='3') {      
/// רביעי    
$('#CancelDayA').find('option').remove().end().append('<option value="">בחר יום</option><option value="2">שלישי</option><option value="1">שני</option><option value="0">ראשון</option><option value="6">שבת</option><option value="5">שישי</option><option value="4">חמישי</option><option value="3" >רביעי</option>'); 
}
else if (Id=='4') {      
/// חמישי    
$('#CancelDayA').find('option').remove().end().append('<option value="">בחר יום</option><option value="3">רביעי</option><option value="2">שלישי</option><option value="1">שני</option><option value="0">ראשון</option><option value="6">שבת</option><option value="5">שישי</option><option value="4" >חמישי</option>');
}
else if (Id=='5') {      
/// שישי    
$('#CancelDayA').find('option').remove().end().append('<option value="">בחר יום</option><option value="4">חמישי</option><option value="3">רביעי</option><option value="2">שלישי</option><option value="1">שני</option><option value="0">ראשון</option><option value="6">שבת</option><option value="5" >שישי</option>'); 
}
else if (Id=='6') {      
/// שבת    
$('#CancelDayA').find('option').remove().end().append('<option value="">בחר יום</option><option value="5">שישי</option><option value="4">חמישי</option><option value="3">רביעי</option><option value="2">שלישי</option><option value="1">שני</option><option value="0">ראשון</option><option value="6" >שבת</option>');
}
else {
...
var SetToTime = $('#SetToTimeA').val();
 ...
 var TypeReminder = $('#TypeReminderA').val();
  ...
  $('#TimeReminderA').prop('min', '');      
  $('#TimeReminderA').val('<?php echo $ClassSettingsInfo->ReminderTimeDayBefore ?>');      
  ...
  $('#CancelTillTimeA').prop('min', '');      
  $('#CancelTillTimeA').val('<?php echo $ClassSettingsInfo->CancelTimeDayBefore ?>');      
