...
<script type="text/template" id="tmpl-elementor-panel-menu">
	...
	<!-- <a onclick="parent.$.fn.colorbox.close();" href="http://<?php echo $_SERVER['SERVER_NAME'] ?>/<?php $pathInPieces = explode('/',$_SERVER['PHP_SELF']);echo $pathInPieces[1];?>" id="elementor-panel-exit-to-dashboard" class="elementor-button elementor-button-default">
			<i class="fa fa-power-off"></i>
			<?php echo __( 'Exits', 'elementor' ); ?>
