...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $rest->answer->sql = DB::table('medical_muscle_mass')->insert($arr);
    ...
    $q = DB::table('medical_muscle_mass as m')
        ->select(
        ...
        // filter by MuscleMass
        if(!empty($_GET['muscleMass'])){
            $q->where('m.MuscleMass', '=', (float) $_GET['muscleMass']);
        }
