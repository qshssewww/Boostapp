...
$reportName = lang('green_passport_report');
...
<script src="assets/js/greenPass/greenPass.js"></script>
        <script>
            $(document).ready(function() {
                BeePOS.options.datatables = <?php echo json_encode(trans('datatables')); ?>;
                var categoriesDataTable = $('#reportGreen').dataTable({
                            ...
                            <div class="tab-pane fade show active text-start" role="tabpanel" id="user-overview">
                                <div class="card spacebottom">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row px-15">
                                            <table class="table table-hover dt-responsive text-start display wrap" id="reportGreen"  cellspacing="0" width="100%">
                                                <thead>
...
<!--                                                    <th style="text-align:start;">--><?php //echo lang('update_date') ?><!--</th>-->
                                                    <th style="text-align:start;"><?php echo lang('green_passport_report_validdate') ?></th>
<!--                                                    <th style="text-align:start;">--><?php //echo lang('covid_declaration') ?><!--</th>-->
                                                    <th style="text-align:start;"><?php echo lang('green_passport_report_status') ?></th>
                                                    <th style="text-align:start;"><?php echo lang('update_date') ?></th>
                                                </tr>
