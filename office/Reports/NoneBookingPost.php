...
$Clients = DB::table('client')->where('CompanyNum','=', $CompanyNum)->where('Status','=', '0')->select('id', 'CompanyName', 'ContactMobile', 'LastClassDate', 'MemberShipText')->get();
$OpenTableCount = '0';
...
->Orwhere('TrueClientId','=',$Client->id)->where('CompanyNum','=',$CompanyNum)->whereBetween('ClassDate', array($StartDateWeek, $EndDateWeek))->where('StatusCount','=','0') 
->select('id')->count();     
