                                    ...
                                    <table class="table table-hover dt-responsive text-right display wrap" id="dataTable" dir="rtl" cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="bg-white text-black filterHeader">
                                                ...
                                                <th style="text-align:right;"><input name="name" type="text" class="form-control" placeholder="חפש"></th>
                                                <th style="text-align:right;"><input name="email" type="text" class="form-control" placeholder="חפש"></th>
                                                <th style="text-align:right;"><input name="phone" type="text" class="form-control" placeholder="חפש"></th>
                                                <th style="text-align:right;">
                                                ...
                                                <th style="text-align:right;"><input name="classRoomName" type="text" class="form-control" placeholder="חפש לפי תחום"></th>
                                            </tr>
