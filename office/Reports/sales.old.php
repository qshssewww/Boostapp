                                    ...
                                    <table class="table table-hover dt-responsive text-right display wrap" id="dataTable" dir="rtl" cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            ...
                                            <tr class="bg-white text-black filterHeader">
                                                ...
                                                <th style="text-align:right;"><input name="amount" type="text" class="form-control" placeholder="חפש"></th>
                                                <th style="text-align:right;">
        ...
        (function($, BeePOS){
            $(document).ready(function(){
                ...
                var fields = {
                    ...
                    productType: $("select[name='productType']", filter),
                    amount: $("input[name='amount']", filter),
                    ...
                    ajax:{
                        ...
                        data: function(d){
                            ...
                            d.filter = {
                                ...
                                productType: fields.productType.val(),
                ...
                table.dataTable(settings).on('xhr.dt', function ( e, s, json, xhr ) {
                    ...
                    json.data = json.items.map(function(x){
                        ...
                        for (let index = 0; index < settings.columns.length; index++) {
                            ...
                            if(settings.columns[index].name === 'amount'){
                                data.push(x.amount?Math.abs(parseFloat(x.amount)).toFixed(2):'0.00');
                                continue;
                            }
