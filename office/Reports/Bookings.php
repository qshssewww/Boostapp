                                    ...
                                    <table class="table table-hover dt-responsive  display wrap" id="dataTable"  cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            <tr class="bg-dark text-white">
                                                ...
                                                <th style="text-align:start;"><?php echo lang('email_table_search') ?></th>
                                            ...
                                            <tr class="bg-white text-black filterHeader">
                                                <th></th>
                                                <th style="text-align:start;"><input name="fullName" type="text" class="form-control" placeholder="<?php echo lang('a_search') ?>"></th>
        ...
        (function($, BeePOS){
            $(document).ready(function(){
                ...
                try{
                    ...
                    fields.classDate.daterangepicker(datepickerOpt.date).on('apply.daterangepicker', function(){table.DataTable().ajax.reload();});
                ...
                var settings = {
                    ...
                    buttons: [
                        ...
                        <?php if (Auth::userCan('98')): ?>    
                            {extend: 'excelHtml5',  text: 'Excel <i class="fas fa-file-excel" aria-hidden="true"></i>', filename: '<?php echo $report->name ?>', className: 'btn btn-dark',exportOptions: {}},
			                {extend: 'csvHtml5', text: 'CSV <i class="fas fa-file-code" aria-hidden="true"></i>', filename: '<?php echo $report->name ?>' , className: 'btn btn-dark',exportOptions: {}}
		                 <?php endif ?>
                    ...
                    ajax:{
                        ...
                        data: function(d){
                            ...
                            // daterange
                            if(fields.classDate.data('daterangepicker') && fields.classDate.data('daterangepicker').startDate){
