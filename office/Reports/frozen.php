                                    ...
                                    <table class="table table-hover dt-responsive text-right display wrap" id="dataTable" dir="rtl" cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            <tr class="bg-dark text-white">
                                                ...
                                                <th class="text-right" data-field="frezeDates">תאריכים</th>
                                                <th class="text-right" data-field="frezeDays">ימים</th>
                                                ...
                                                <th class="text-right" data-field="clientEmail">מייל</th>
                                                <th class="text-right" data-field="branchName">סניף</th>
                                            </tr>
                                            <tr class="bg-white text-black filterHeader">
                                                <th class="text-right" data-field="clientId"></th>
                                                <th class="text-right" data-field="frezeDates">
                                                    <input type="text" name="frezeDates" class="form-control" placeholder="חפש">
                                                </th>
                                                <th class="text-right" data-field="frezeDays">
                                                    <input type="number" name="frezeDays" class="form-control" placeholder="חפש" min="0">
                                                </th>
                                                ...
                                                <th class="text-right" data-field="clientEmail">
                                                    <input type="text" name="clientEmail" class="form-control" placeholder="חפש">
                                                </th>
    ...
    <script>
        (function($, BeePOS) {
            $(document).ready(function() {
                ...
                var fields = {
                    frezeDates: jQuery('[name="frezeDates"]', filter),
                    frezeDays: jQuery('[name="frezeDays"]', filter),
                    ...
                    clientEmail: jQuery('[name="clientEmail"]', filter),
                    branchName: jQuery('[name="branchName"]', filter)
                }

                try {
                    fields.frezeDates.daterangepicker({
                ...
                table.dataTable(settings).on('xhr.dt', function(e, settings, json, xhr) {
                    ...
                    json.data = json.items.map(function(x) {
                        ...
                        data.push(x.frezeDates || 0);
                        data.push(x.frezeDays || 0);
