                                    ...
                                    <table class="table table-hover dt-responsive text-start display wrap" id="dataTable"  cellspacing="0" width="100%">
                                        ...
                                        <thead>
                                            <tr class="bg-dark text-white">
                                                ...
                                                <!-- <th style="text-align:start;">אחוזי הרשמה</th> -->
            ...
            $(document).ready(function(){
                ...
                table.dataTable(settings).on('xhr.dt', function ( e, settings, json, xhr ) {
                    ...
                    json.data = json.items.map(function(x){
                        var data = [];
                        data.push(x.date || 0); // תאריך
                        data.push(x.classStartTime || 0); // תאריך
                        data.push(x.className || 0); // שם שיעור
                        ...
                        data.push((100-percent).toFixed(2) + '%'); // אחוזי הגעה
                        // data.push((percent).toFixed(2) + '%'); // אחוזי אי הגעה
                        ...
                        data.push(((((parseInt(x.ClientRegister) - parseInt(x.absent)) / parseInt(x.MaxClient)) *100).toFixed() +'%'));  // אחוזי הגעות
                        data.push(x.ClientRegister);  // הגעות
                        
                        data.push( parseInt(x.ClientRegister) - parseInt(x.absent) );  // הגעות
                        data.push(x.absent ); // לא היגוע
