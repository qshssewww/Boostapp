...
<?php if (Auth::check()):?>
<?php if (Auth::userCan('145')): ?>
<?php
CreateLogMovement('נכנס לדוח אי שיבוץ קבוע', '0');
?>
...
//	        pageLength: 5000,
		...
		//{extend: 'copy', text: 'העתק <i class="fa fa-clipboard" aria-hidden="true"></i>', className: 'btn btn-info'},
			{extend: 'excelHtml5',  text: 'Excel <i class="fas fa-file-excel" aria-hidden="true"></i>', filename: 'אי שיבוץ קבוע', className: 'btn btn-dark'},
			{extend: 'csvHtml5', text: 'CSV <i class="fas fa-file-code" aria-hidden="true"></i>', filename: 'אי שיבוץ קבוע' , className: 'btn btn-dark'},
...
<i class="fas fa-calendar-alt"></i> דוח אי שיבוץ קבוע</span>
</div>
</h3>
</div>
...
<a href="RegularReport.php" class="btn btn-success btn-block" dir="rtl">דוח שיבוץ קבוע</a>    
...
<nav aria-label="breadcrumb" dir="rtl">
  ...
  <li class="breadcrumb-item active">דוח אי שיבוץ קבוע</li>
  </ol>  
</nav>     -->
<div class="row">
    <div class="d-flex col-md-2 pb-10 margin-a">
        <a href="RegularReport.php" class="btn btn-primary btn-block">דו"ח שיבוץ קבוע</a>
    </div>
</div> 
<div class="row">
...
<div class="col-md-10 col-sm-12 order-md-1">	
    ...
    <i class="fas fa-calendar-alt"></i> <b>דוח אי שיבוץ קבוע</b>
 	</div>    
  	<div class="card-body">       
