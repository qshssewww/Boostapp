...
<i class="fas fa-align-right"></i> ניהול PIPELINE <span style="color:#48AD42;"><?php //echo $resultcount; ?> </span>
</div>
</h3>
</div>
...
<a href="#" data-ip-modal="#PipelinePopup" class="btn btn-success btn-block" name="Items"  ><i class="fas fa-plus-circle fa-fw"></i> PIPELINE חדש</a>
<?php //endif; ?>    
</div>
...
<nav aria-label="breadcrumb" >
  ...
  <li class="breadcrumb-item active">ניהול PIPELINE</li>
  </ol>  
</nav>     -->
