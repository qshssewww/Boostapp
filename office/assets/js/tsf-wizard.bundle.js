...
(function(factory) {
    ...
    var _this, _navPos, _stepEff, _left, _notShownField, _windowWidth, _stepStyle, _width, _height, _currIndex, _from, _to, _element, _disableSteps, _stepDisable, activeIndex, _content, _parent, _oldIndex, _return, _newIndex, _id, _step_effect, _count, _finish, _first, _btnPrev, _btnNext, _btnFinish, _index, _dataType;
    var _fistVal = false,
        _isValid = true;
