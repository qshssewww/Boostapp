...
<input type="hidden" name="ClassType" value="<?php echo $GetClassInfo->ClassType; ?>">                        
 ...
 <div class="col-md-4">	 
  ...
  <label><?php echo lang('lesson_type') ?></label>
    <select class="form-control js-example-basic-single select2Desk text-start" name="ClassNameType" id="ClassNameTypeNew"  data-placeholder="<?php echo lang('choose_lesson_type') ?>" style="width:100%;" disabled>
    <option value=""></option>    
  <?php 
 ...
 <input type="text" class="form-control" name="ClassName" id="ClassNameNew" value="<?php echo $GetClassInfo->ClassName; ?>" disabled>
 <div class="help-block with-errors"></div>      
 </div>      
...
<div class="col-md-4">	     
  ...
  <label><?php echo lang('instructor') ?></label>
    <select class="form-control js-example-basic-single select2Desk text-start" name="GuideId" id="GuideId"  data-placeholder="<?php echo lang('choose_lesson_instructor') ?>" disabled style="width:100%;" >
    <option value=""></option>    
  <?php 
  if (Auth::user()->BrandsMain=='0'){        
...
<div class="col-md-4">	     
  ...
  <label><?php echo lang('instructor_help') ?></label>
    <select class="form-control js-example-basic-single select2Desk text-start" name="ExtraGuideId" id="ExtraGuideId"  data-placeholder="<?php echo lang('choose_lesson_instructor') ?>" disabled  style="width:100%;">
    <option value=""></option>    
  <?php 
  if (Auth::user()->BrandsMain=='0'){        
  $SectionInfos = DB::table('users')->where('CompanyNum','=',$TrueCompanyNum)->where('ActiveStatus','=','0')->where('Coach','=','1')->orderBy('display_name', 'ASC')->get();
  ...
  <label><?php echo lang('is_displayed_in_app') ?></label>
    <select class="form-control js-example-basic-single text-start" name="ShowApp" id="ShowApp"  disabled>
...
<?php if(!empty($GetClassInfo->liveClassLink)) { ?>
<div class="row" id="liveSection">
    <div class="col-md-4">
      <div class="form-group">
        <label><?php echo lang('registration_options') ?></label>
        <select class="form-control js-example-basic-single text-start" name="registerLimit" id="registerLimit"  disabled>
          <option value="1" <?php if($GetClassInfo->registerLimit == 1) echo 'selected'; ?>><?php echo lang('by_subscription_restrict') ?></option> 
    ...
    <div class="col-md-8">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="liveClassLink" id="liveClassLink" dir="ltr" required value="<?php echo $GetClassInfo->liveClassLink ?>" disabled>      
        <div class="help-block with-errors"></div>
      </div>
    </div>
  </div>
<?php }?>
    <?php if(isset($zoom) && $GetClassInfo->is_zoom_class == 1) { ?>
    <div class="zoomSection row" id="zoomSection">
        <!--    <div class="col-md-4">-->
        <!--        <div class="form-group">-->
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="number" class="form-control" disabled placeholder="" value="<?php echo isset($zoom->meeting_id) ? $zoom->meeting_id : "" ?>" required name="meetingNumber" id="meetingNumber" >
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label>סיסמה</label>
                <input disabled class="form-control" placeholder="" value="<?php echo isset($zoom->password) ? $zoom->password : "" ?>" name="ZoomPassword" id="password" >
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label><?php echo lang('lesson_prop') ?></label>
                <select disabled class="form-control js-example-basic-single text-start" name="registerLimitZoom" id="registerLimitZoom" >
        ...
        <div class="col-md-4 singleReg">
            <div class="repalce-check-box form-group">
                <div style="display: flex">
                    <input disabled type="checkbox" <?php echo (isset($zoom->single_reg) && $zoom->single_reg == 1) ? "checked" : "" ?> id="AllowSingleEntry" name="AllowSingleEntry" >
                    <span class="checkmark"></span>
                    <label><?php echo lang('allow_one_class') ?></label>
                </div>
                <input type="number" disabled class="form-control" placeholder="<?php echo lang('price_to_charge') ?> (₪)" value="<?php echo isset($zoom->single_price) ? $zoom->single_price : "" ?>" name="singleEntryRate" id="singleEntryRate" >
            </div>
        </div>
...
?>  
 ...
 <select name="DayOld" id="DayNew" data-placeholder="<?php echo lang('choose_day') ?>" class="form-control" style="width:100%;" disabled>
     ...
     <option value="0" <?php if ($GetClassInfo->DayNum=='0') { echo 'selected'; } else {} ?> ><?php echo lang('sunday') ?></option>
     <option value="1" <?php if ($GetClassInfo->DayNum=='1') { echo 'selected'; } else {} ?> ><?php echo lang('monday') ?></option>
     <option value="2" <?php if ($GetClassInfo->DayNum=='2') { echo 'selected'; } else {} ?> ><?php echo lang('tuesday') ?></option>
     <option value="3" <?php if ($GetClassInfo->DayNum=='3') { echo 'selected'; } else {} ?> ><?php echo lang('wednesday') ?></option>
     <option value="4" <?php if ($GetClassInfo->DayNum=='4') { echo 'selected'; } else {} ?> ><?php echo lang('thursday') ?></option>
     <option value="5" <?php if ($GetClassInfo->DayNum=='5') { echo 'selected'; } else {} ?> ><?php echo lang('friday') ?></option>
     <option value="6" <?php if ($GetClassInfo->DayNum=='6') { echo 'selected'; } else {} ?> ><?php echo lang('saturday') ?></option>
...
<div class="help-block with-errors"></div> 
 ...
 <div class="col-md-3">	     
  ...
  <label><?php echo lang('begin_time') ?></label>
	  <input name="SetTime" id="SetTimeNew" type="time" step="300" value="<?php echo blockMinutesRound($GetClassInfo->StartTime); ?>" class="form-control" disabled> 
    <div class="help-block with-errors"></div>     
	</div> 
  </div>
 ...
 <div class="col-md-3">	     
  ...
  <label><?php echo lang('finish_time') ?></label> 
	 <input name="SetToTime" id="SetToTimeNew" type="time" step="300" min="<?php echo blockMinutesRound(date(('H:i'), strtotime("+5 minutes", strtotime($GetClassInfo->StartTime)))); ?>" value="<?php echo $GetClassInfo->EndTime; ?>" class="form-control" disabled>  
    <div class="help-block with-errors"></div>     
	</div> 
  </div>      
 ...
 <div id="DivClassTypeNew" class="col-md-3" style="display: <?php if ($GetClassInfo->ClassType=='2') { echo 'selected'; } else { echo 'none'; } ?>;">	        
  ...
  <input type="number" class="form-control" name="ClassCount" id="ClassCountNew" value="<?php echo $GetClassInfo->ClassCount; ?>" min="1" onkeypress='validate(event)' disabled> 
  <div class="help-block with-errors"></div>      
  </div>
 </div>  
 ...
 <div id="DivClassTypeNew4" class="col-md-3" style="display: <?php if ($GetClassInfo->ClassType=='4') { echo 'selected'; } else { echo 'none'; } ?>;">	        
  ...
  <input type="number" class="form-control" name="ClassRepeat" id="ClassRepeat" value="<?php echo $GetClassInfo->ClassRepeat; ?>" min="1" onkeypress='validate(event)' disabled>
  <div class="help-block with-errors"></div>      
  </div>
 </div>          
  ...
  <label><?php echo lang('max_participants') ?></label>
	<input type="number" min="1" class="form-control" name="MaxClient" id="MaxClientNew" value="<?php echo $GetClassInfo->MaxClient; ?>" onkeypress='validate(event)' disabled>  
    <div class="help-block with-errors"></div>    
	</div> 
  </div>                      
<div class="col-md-6">
 ...
 <div class="form-group">
  ...
  <select class="form-control text-start" name="ClassLimitTypes" id="ClassLimitTypes"  disabled>
...
<select class="form-control js-example-basic-single select2multipleDesk newid<?php echo $Fixi ?> text-start" name="ClassMemberType<?php echo $Fixi ?>[]" id="ClassMemberType<?php echo $Fixi ?>"   multiple="multiple" data-select2order="true" style="width: 100%;" disabled>  
                <?php 
...
<input type="hidden" id="CheckClassMemberType<?php echo $Fixi; ?>" value="" disabled>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-3">
<div class="form-group" >
<label><?php echo lang('max_participants') ?></label>
<input type="number" min="1" name="MaxClientMemberShip<?php echo $Fixi; ?>" id="MaxClientMemberShip<?php echo $Fixi; ?>" class="form-control MaxClientMemberShip" value="<?php echo $CheckLimitCount->Value; ?>" disabled>
</div>
</div>
<div class="col-md-3" style="padding-top: 35px;" >
<a href="javascript:;" class="btn btn-danger btn-sm" disabled onclick='remove444Elementgroup("Group<?php echo $Fixi; ?>Div","<?php echo $Fixi; ?>")' title="<?php echo lang('remove_restrict') ?>"><?php echo lang('remove_restrict') ?> <i class="fas fa-trash-alt"></i></a>    
...
<a class="btn btn-dark btn-sm" href="javascript:void(0);" onclick="addElementgro3433up();" disabled><?php echo lang('add_new_restrict') ?>+</a>   
<input type="hidden" value="<?php echo $GetClassInfoCount; ?>" id="theValueGroup" name="tGroups"/>         
 ...
 <div class="col-md-3">	     
  ...
  <select class="form-control text-start" name="MinClass" id="MinClassNew"  disabled>
  ...
  <label><?php echo lang('min_participants') ?></label>
	<input type="number" class="form-control" name="MinClassNum" id="MinClassNumNew" value="<?php echo $GetClassInfo->MinClassNum ?>" onkeypress='validate(event)' disabled> 
    <div class="help-block with-errors"></div>  
	</div>  
  </div>
  ...
  <label><?php echo lang('check_time_before_class') ?></label>
	<input type="text" class="form-control" name="ClassTimeCheck" id="ClassTimeCheckNew" value="<?php echo $GetClassInfo->ClassTimeCheck ?>" disabled> 
    <div class="help-block with-errors"></div>    
	</div>
    </div>   
     <div class="col-md-3 DivMinClassNumNew" style="display: <?php if ($GetClassInfo->MinClass=='1') { echo 'selected'; } else { echo 'none'; } ?>;">	   
    ...
    <select class="form-control text-start" name="ClassTimeTypeCheck" id="ClassTimeTypeCheckNew"  disabled>
  ...
  <select class="form-control text-start" name="ClassWating" id="ClassWatingNew"  disabled>
  ...
  <select class="form-control text-start" name="MaxWatingList" id="WatingListActNew"  disabled>
  ...
  <input type="number" class="form-control" name="NumMaxWatingList" id="WatingListNumNew" value="<?php echo $GetClassInfo->NumMaxWatingList ?>" onkeypress='validate(event)' disabled> 
  <div class="help-block with-errors"></div>       
  </div> 
  </div>
  ...
  <select class="form-control js-example-basic-single select2LimitLevel text-start" data-placeholder="<?php echo lang('select_rank') ?>"  name="LimitLevel[]" id="LimitLevel"   multiple="multiple" data-select2order="true" style="width: 100%;" disabled>
...
<div class="form-group">
  ...
  <select class="form-control text-start" name="GenderLimit" id="GenderLimit"  disabled>
...
<div class="col-md-4">
 ...
 <div class="form-group">
  ...
  <select class="form-control text-start" name="FreeClass" id="FreeClass"  disabled>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-start" name="SendReminder" id="SendReminderNew"  disabled>
  ...
  <select class="form-control text-start" name="TypeReminder" id="TypeReminderNew"  disabled>
  ...
  <input type="time" class="form-control" name="TimeReminder" id="TimeReminderNew" step="300" value="<?php echo $GetClassInfo->TimeReminder ?>" max="" min="" disabled>
  <div class="help-block with-errors"></div>      
  </div> 
  </div>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-start" name="CancelLaw" id="CancelLawNew"  disabled>
  ...
  <select name="CancelDay" id="CancelDayNew" data-placeholder="<?php echo lang('choose_day') ?>" class="form-control" style="width:100%;" disabled>
  ...
  <input name="CancelTillTime" id="CancelTillTimeNew" type="time" step="300" min="" value="<?php echo $GetClassInfo->CancelTillTime; ?>" class="form-control" disabled> 
   <div class="help-block with-errors"></div>       
  </div> 
  </div>
    ...
    <div id="DivCancelLawNew6" class="alertb alert-warning" style="display: <?php if ($GetClassInfo->CancelLaw=='3') { echo 'block'; } else { echo 'none'; } ?>;"><?php echo lang('select_day_notice_one') ?> <u><?php echo lang('day') ?></u> <?php echo lang('before_class_day_notice') ?><br>
    <?php echo lang('attention_must_choose_day_before_lesson') ?></div> 
    
    
    <div id="DivCancelLawNew4" class="alertb alert-warning" style="display: <?php if ($GetClassInfo->CancelLaw=='4') { echo 'block'; } else { echo 'none'; } ?>;"><?php echo lang('class_unable_cancel_app') ?></div>   
       
    <div id="DivCancelLawNew5" class="alertb alert-warning" style="display: <?php if ($GetClassInfo->CancelLaw=='5') { echo 'block'; } else { echo 'none'; } ?>;"><?php echo lang('attention_client_cannot_cancel_anytime_free') ?></div>                          
  <hr>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-start" name="StopCancel" id="StopCancel"  disabled>
  ...
  <input type="number" class="form-control" name="StopCancelTime" id="StopCancelTime" value="<?php echo $GetClassInfo->StopCancelTime; ?>" onkeypress='validate(event)' disabled>        
  <div class="help-block with-errors"></div>        
  </div> 
  </div>
  ...
  <div class="form-group">
  <label><?php echo lang('option') ?></label>
  <select class="form-control text-start" name="StopCancelType" id="StopCancelType"  disabled>
  ...
  <select class="form-control text-start" name="ShowClientNum" id="ShowClientNum"  disabled>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-start" name="ShowClientName" id="ShowClientName"  disabled>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-start" name="WatingListOrederShow" id="WatingListOrederShow"  disabled>
 ...
 <div class="col-md-3">	     
  <div class="form-group">
    <label><?php echo lang('set_class') ?></label>
  <select class="form-control text-start" name="ClassLevel"  disabled>
...
<div class="form-group">
  <label><?php echo lang('class_details_order_class') ?></label>
    <select class="form-control js-example-basic-single select2Desk text-start" name="ClassDevice" id="ClassDevice"  data-placeholder="<?php echo lang('choose_gym_equipment_table') ?>"  style="width: 100%;" disabled>
    <option value=""></option>    
  <?php 
...
<hr>
 ...
 <div class="col-md-4">	     
  <div class="form-group">
  <label><?php echo lang('class_details_order_class') ?></label>
  <select class="form-control text-start" name="OpenOrder" id="OpenOrder"  disabled>
  ...
  <div class="col-md-4 OpenOrder" style="display: <?php if ($GetClassInfo->OpenOrder=='0') { echo 'selected'; } else { echo 'none'; } ?>;">	     
   <div class="form-group">
  <label><?php echo lang('set_time_before_class') ?></label>
  <input type="number" class="form-control" name="OpenOrderTime" id="OpenOrderTime" value="<?php echo $GetClassInfo->OpenOrderTime; ?>" onkeypress='validate(event)' disabled>        
  <div class="help-block with-errors"></div>        
  </div> 
  </div>
  ...
  <div class="form-group">
  <label><?php echo lang('option') ?></label>
  <select class="form-control text-start" name="OpenOrderType" id="OpenOrderType"  disabled>
 ...
 <div class="col-md-4">	     
  ...
  <select class="form-control text-start" name="CloseOrder" id="CloseOrder"  disabled>
  ...
  <div class="col-md-4 CloseOrder" style="display: <?php if ($GetClassInfo->CloseOrder=='0') { echo 'selected'; } else { echo 'none'; } ?>;">	     
   <div class="form-group">
  <label><?php echo lang('set_time_before_class') ?></label>
  <input type="number" class="form-control" name="CloseOrderTime" id="CloseOrderTime" value="<?php echo $GetClassInfo->CloseOrderTime; ?>" onkeypress='validate(event)' disabled>        
  <div class="help-block with-errors"></div>        
  </div> 
  </div>
  ...
  <div class="form-group">
  <label><?php echo lang('option') ?></label>
  <select class="form-control text-start" name="CloseOrderType" id="CloseOrderType"  disabled>
  ...
  <div class="alertb alert-warning CloseOrder" style="display: <?php if ($GetClassInfo->CloseOrder=='0') { echo 'selected'; } else { echo 'none'; } ?>;"><?php echo lang('class_unable_cancel_app') ?></div>          
  ...
  $(document).ready(function(){
      ...
      if(zoomReg == "1"){
          ...
          singleReg.hide();
            ...
            var btnCancel = $('<button type="button" class="BtnClassWizs"></button>').text('<?php echo lang('close') ?>')
                                             .addClass('btn btn-success')
                                             .on('click', function(){
