...
<head>
    ...
    <script src="/assets/office/dist/refund.bundle.js" defer></script>
...
<body id="refundfPage" class="<?= $theme_prefix; ?>__checkout-page">
...
<header id="header" class="fixed d-flex">
    <div class="header--bar-title centralize d-none d-lg-flex align-items-center justify-content-center">
        <h2 class="h3 title"><?= lang('refund_title_page') ?></h2>
    </div>
...
<!--        </a>-->
        <h2 class="h3 title header--bar-mob-title"><?= lang('documents_refund') ?></h2>
        <a href="/office"
