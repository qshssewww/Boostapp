...
$pageTitle = lang('reports_terms_title');
...
//	        pageLength: 5000,
		...
		//{extend: 'copy', text: 'העתק <i class="fa fa-clipboard" aria-hidden="true"></i>', className: 'btn btn-info'},
			...
			{extend: 'csvHtml5', text: 'CSV <i class="far fa-file-code" aria-hidden="true"></i>', filename: '<?php echo lang('reports_terms_title') ?>' , className: 'btn btn-sm btn-light text-gray-400 font-weight-bold mie-5'},
...
<i class="fas fa-address-book"></i> דוח תקנון</span>
</div>
</h3>
</div>
...
<div class="col-md-10 col-sm-12">	
    ...
    <i class="fas fa-address-book"></i> <b><?php echo lang('reports_terms_title') ?></b>
 	</div>    
  	<div class="card-body">       
...
<table class="table table-hover dt-responsive  display wrap text-start " id="categories"  cellspacing="0" width="100%">
		<thead >
			<tr class="">
				<th class=""><?php echo lang('client') ?></th>
                <th class=""><?php echo lang('telephone') ?></th>
                <th class=""><?php echo lang('client_status') ?></th>
                <th class=""><?php echo lang('terms') ?></th>
                <th class=" lastborder"><?php echo lang('date_signed') ?></th>
			</tr>
...
<option><?php echo lang('there_is_not') ?></option>
    ...
    <th><span><?php echo lang('date_signed') ?></span></th>
            </tr>      
