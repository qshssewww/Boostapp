...
proton.dashboard = {
	...
	drawCharts : function () {
		...
		proton.dashboard.graph.Donut = Morris.Donut({
		    element: 'hero-donut',
		    data: [
		      {label: 'הזמנות', value: 30 },
		      {label: 'השכרת ציוד', value: 40 },
		      {label: 'צלילות', value: 25 },
		      {label: 'מכירות', value: 5 }
		    ],
	...
	alerts : function () {
		...
		setTimeout(function(){
		    $.pnotify({
		        ...
		        type: 'info',
		        history: false,
		        text: 'לתמיכה טכנית והסבר על שימוש במערכת החדשה ניתן להתקשר בין השעות 08:30-18:00 לטלפון 08-9109092, 057-5885668'
		    });
		}, 3000);
	}
}