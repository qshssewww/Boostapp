...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        lang: { // Language variables for button
            next: $('html').attr('dir') == 'rtl' ? lang('next_client_profile') : 'next',
            previous: $('html').attr('dir') == 'rtl' ? lang('the_previous') : 'prev'
        },
        toolbarSettings: {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnGroup = $('<div dir="ltr" align="left"></div>').addClass('btn-group mr-2 sw-btn-group').attr('role', 'group').append(btnNext, btnPrevious);

            // Add extra toolbar buttons
            var btnGroupExtra = null;

            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('<div dir="ltr" align="left"></div>').addClass('btn-group mr-2 sw-btn-group-extra').attr('role', 'group');
             ...
             var btnGroupExtraCancel = null;

            if (this.options.toolbarSettings.toolbarExtraCancelButtons && this.options.toolbarSettings.toolbarExtraCancelButtons.length > 0) {
                btnGroupExtraCancel = $('<div dir="ltr" align="right"></div>').addClass('btn-group mr-2 sw-btn-group-extra').attr('role', 'group');
                $.each(this.options.toolbarSettings.toolbarExtraCancelButtons, function (i, n) {
                    btnGroupExtraCancel.append(n.clone(true));
                });
                
            }
            

            var toolbarTop, toolbarBottom, toolbarBottomCancel;
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                ...
                case 'bottom':
                    ...
                    toolbarBottomCancel = $('<div style="flex: 1;"></div>').addClass('justify-content-start');
                    
                    toolbarBottom.append(toolbarBottomCancel, btnGroup);
                    if (this.options.toolbarSettings.toolbarButtonPosition === 'start') {
                        toolbarBottomCancel.prepend(btnGroupExtraCancel);
                        toolbarBottom.prepend(btnGroupExtra);
                        
                    } else {
                        toolbarBottomCancel.append(btnGroupExtraCancel);
