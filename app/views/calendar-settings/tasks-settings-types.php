<!-- Tasks Types Settings Module :: Panel begin -->
<div class="bsapp-settings-panel calendarSettings-tasks-settings-types d-none flex-column overflow-hidden position-absolute h-100 w-100 bg-white p-15 animated slideInStart"
     data-depth="2">
                    ...
                    <div class="bsapp-editable-field js-editable-item">
                        ...
                        <div class="js-part-edit w-100 h-40p text-gray-700 mb-12 d-none justify-content-between align-items-center border px-8 border border-success"
                            ...
                            <input class="border-0 shadow-0 form-control flex-fill bsapp-edit-input js-input-div"
                                   onchange="TasksSettings.addClassChanged(this)" maxlength=30
