...
?>
<div class="bsapp-settings-panel calendarSettings-calendars-and-classes_calendars d-none flex-column overflow-hidden position-absolute h-100 w-100 bg-white p-15 animated slideInStart" data-depth="2">
  ...
  <h3 class="d-flex align-items-center text-gray-700 font-weight-bolder mb-20 bsapp-fs-14">
    <i class="fal fa-tasks-alt mie-6 text-gray-500 bsapp-fs-19"></i>
      <?php echo lang('path_calendar_classes_types') ?>
  </h3>
  ...
  <div class="scrollable">
    <div class="pb-50">
      ...
      <ul class="calendars-list list-unstyled p-0 bsapp-fs-14">
  ...
  <div class="position-absolute bottom-0 left-0 bg-white p-15 pt-10 w-100">
    <a class="new-calendar btn btn-lg btn-primary text-white rounded-lg font-weight-bolder shadow-none border-0 w-100 bsapp-fs-16" role="button"><?php echo lang('cal_calendar_add') ?></a>
  </div>
</div>