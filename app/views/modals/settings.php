							...
							<script type="text/html" id="contactItemTemplate">
								<li class="list-group-item <% if (accepted) { %>contact-confirmed<% } %>" data-contact-id="<%= id %>">
									...
									<div class="pull-right">
										<span class="confirmed"><a href="javascript:BeePOS.confirmContact(<%= id %>)"><?php _e('main.confirm_contact') ?></a> |</span>
										<a href="javascript:BeePOS.removeContact(<%= id %>)"><?php _e('main.remove') ?></a>
									</div>
								</li>
							</script>
						</div>
