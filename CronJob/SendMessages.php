...
try {
    ...
    for ($i = 0; $i < $iterations; $i++) {
        ...
        $EmailsLogo = App::url('assets/img/LogoMail.png');
        ...
        foreach ($SendMessages_splice as $SendMessage) {
            ...
            if (!empty($OpenTables->settingsId)) {
                ...
                if (($SendMessage->Date == $ThisDate && $SendMessage->Time <= $ThisTime) || $SendMessage->Date < $ThisDate) {
                    ...
                    if (!empty($OpenTables->PhoneSMSTitle)) {
                    ...
                    if (($OpenTables->Memotag == '1' && $OpenTables->DocsCompanyLogo != '') || $OpenTables->CompanyNum == '274835') {

                        $EmailsLogo = App::url('office/files/' . $OpenTables->DocsCompanyLogo);
                    ...
                    $unsubscribeText = '"<p>להסרה מרשימת דיוור <a href="https://1ba.co/r/' . $OpenTables->id . '/sms">לחץ כאן</a></p>"';
                    ...
                    if ($SendMessage->Type == '0') { ///  שליחת התראה באפליקציה
                        ...
                        } elseif (@$tokenFirebase == '' && $SendSMS == '1' && $GetSMS == '0') { /// שולח הודעת טקסט במקום
...
להסרה: 1ba.co/r/' . $OpenTables->id . '/sms
                        ...
                        } elseif (@$tokenFirebase == '' && $SendSMS == '2' && $EmailTrue != '' && $GetEmail == '0') { /// שולח דואר אלקטרוני
...
<p align ="center" style="font-family:Arial; font-size:11px;">להסרה מרשימת דיוור <a href="https://1ba.co/r/' . $OpenTables->id . '/email"> לחץ כאן</a></p>
